...
class Tutor_final_presentation extends CI_Controller {
    ...
    public function index() {
        ...
        $data['title'] = 'Tutors Final Presentation';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/menu', $data);
        $this->load->view('tutors_final_presetation/index', $data);
    ...
    public function download_file() {
        ...
        if (is_file("uploads/$filename")) {
            ...
            redirect(base_url() . Tutor_final_presentation);
        }
    }
