        ...
        <div class="col-md-12">
            <div class="login-panel panel panel-primary" style="margin-top: 5%;">
                <div class="panel-heading ">
                    <h3 class="panel-title">Detail tutor information</h3>
                </div>
                <div class="panel-body">
                    ...
                    foreach ($tutor_data as $users_item) {
                        if ($users_item['Id'] == $user_id) {
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">             
                                    <a href="<?php echo base_url(); ?>tutorsusers" class="btn btn-danger btn-md"><span class=" glyphicon glyphicon-circle-arrow-left"></span> &nbsp;&nbsp;Back</a>
                                </div>
                            </div>
                            </form>
                            <?php
