                        ...
                        <br>  
                            <table class="table table-striped table-bordered table-hover" id="users">
                                ...
                                <tbody>
                                    ...
                                    if ($get_answer != "" && $get_answer != null) {
                                        $i=0;
                                        foreach ($get_answer as $question_row) {
                                            $i++;
                                            ?>
                                            <tr>                                                
                                <form method="post" action="<?php echo base_url(); ?>StudentSurveys/c_update_answer/<?php echo $survey_value['Survey_Id'];?>"> 
                                        <input type="hidden" value='<?php echo  $question_row['AnswersId']; ?>' name="answerIdHidden[]">
                                        <input type='hidden' value="<?php echo ($question_row['Ismandatory'] == 1) ? '1' : '0' ?>" name="checkManHidden[]">
                                        <td><?php echo '<b>' . $i . '. ' . $question_row['QuestionTitle'] . '</b>'; ?>
                                            ...
                                            <textarea name='AnswerText[]' class="form-control" rows="2" cols="50%" value=""><?php echo $question_row['AnswerText']?></textarea>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <button type="submit" class="btn btn-primary" value="1" name="Isreturn" > <span class="glyphicon glyphicon-floppy-disk glyphicon-white"></span>&nbsp; submit</button>
                                        <!--<a href="<?php // echo base_url(); ?>StudentSurveys/c_update_answer/<?php // echo $survey_value['Survey_Id'];?>" ><button type="button" class="btn btn-success"   name="Isreturn" value="1"> <span class="glyphicon glyphicon-share glyphicon-white"></span>&nbsp; Submit</button> </a>-->  
