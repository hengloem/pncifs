            ...
            <div class="login-panel panel panel-default" style="margin-top: 5%;">
                ...
                <div class="panel-body">
                    ...
                    if ($surveys_data != "") {
                        foreach ($surveys_data as $survey_value) {
                            ...
                            echo form_open('SurveysByTutor/c_process_submit/' . $survey_value['Survey_Id'], $attributes);
                            ?> 
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="users">
                                            ...
                                            <tbody>
                                                ...
                                                if ($answers_data != "") {
                                                    $id = 1;
                                                    foreach ($answers_data as $question_row) {
                                                        ?>
                                                        <tr>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                    <a href="<?php echo base_url(); ?>surveysbytutor/c_process_submit/<?php echo $survey_value['Survey_Id'];?>" >
               ...
               <?php
                ...
                foreach ($answers_data as $question_row) {
                    ...
                    $attributes = array('id' => 'frmUserForm', 'class' => 'form-horizontal');
                    //form : action='url'
                    echo form_open('surveysbytutor/c_process_report/' .$question_row['QuestionId'], $attributes);
                ?>
