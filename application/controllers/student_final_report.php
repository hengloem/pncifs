...
class Student_final_report extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['title'] = 'Student Final Report';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/menu', $data);
        $this->load->view('student_final_report/index', $data);
    ...
    public function download_file() {
        ...
        if (is_file("uploads_report/$filename")!='') {
            ...
            redirect(base_url().'student_final_report/index/'.$id);
        }
    }
