...
class Adminsurvey_model extends CI_Model{
    /**
     * Default constructor
     */
    ...
    //Date: Moday 29, May 2017 Time: 14:26 pm
    /**
...
/**
    ...
    public function m_get_checked_report($id, $userId){
        ...
        $this->db->join('reports rp','ans.AnswerId = rp.Answers_Id','inner');
