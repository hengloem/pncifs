...
class Final_pres extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $this->load->view('admin_final_presetation/index', $data);
    ...
    public function delete($id) {
        $data = array('FinalPresTemplateFileName' => NULL);
//        echo $_SESSION['tem_file_name'];
        if($this->batchs_model->m_update_file_name($id,$data)){
            unlink('uploads/'.$_SESSION['tem_file_name']);
