<div class="container-fluid" id="wrap">
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            <h1>Your follow up student's survey</h1>
            <!-- Search student that tutors follow up -->
            <form method="POST" action="<?php echo base_url(); ?>Survey_by_admin" name="getstudent">
            ...
            <!--End of filter-->
            <!--New survey-->
            <label class="control-label" style="color: red;">List of new student's survey</label> 
                        ...
                        if($student_survey_data != ""){
                            foreach($student_survey_data as $survey_row){
                                ...
                                <tr>
                                    ...
                                    <td data-order="1">
                                        <div>
                                            <a href="<?php echo base_url(); ?>Survey_by_admin/c_preview_survey_detail/<?php echo $survey_row['Survey_Id'].'/'.$survey_row['UsersId'] ?>" title="Preview">
            ...
            <!--Done survey-->
            <label class="control-label" style="color: red;">List of done student's survey</label> 
            <div class="table-responsive">
                <br>
                        ...
                        if($tutor_checked_survey_data != ""){
                            foreach($tutor_checked_survey_data as $survey_row){
                                ...
                                <tr>
                                    ...
                                    <td data-order="1">
                                        <div>
                                            <a href="<?php // echo base_url(); ?>Survey_by_admin/c_preview_checked_survey/<?php echo $survey_row['Survey_Id'].'/'.$survey_row['UsersId'] ?>" title="Check again"><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                                        </div>
                                    </td>             
                                </tr>
                            <?php 
